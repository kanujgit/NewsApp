...
class ScienceFragment : Fragment(), NewsArticlesAdapter.OnItemClickListener {
...
//        viewModel = ViewModelProvider(this).get(CommonCategoryViewModel::class.java)
        ...
        adapter.setOnItemClickListener(this@ScienceFragment)

        viewModel.fetchTopHeadlines(getString(R.string.ic_title_science))
        viewModel.fetchTopHeadlines(getString(R.string.ic_title_science))
