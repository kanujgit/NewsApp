...
class BusinessFragment : Fragment(), NewsArticlesAdapter.OnItemClickListener {
...
//        viewModel = ViewModelProvider(this).get(CommonCategoryViewModel::class.java)
        ...
        adapter.setOnItemClickListener(this@BusinessFragment)


        viewModel.fetchTopHeadlines(getString(R.string.ic_title_business))
        viewModel.fetchTopHeadlines(getString(R.string.ic_title_business))
