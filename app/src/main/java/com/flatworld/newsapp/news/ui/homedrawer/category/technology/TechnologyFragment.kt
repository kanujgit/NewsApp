...
class TechnologyFragment : Fragment(), NewsArticlesAdapter.OnItemClickListener {
...
//        viewModel = ViewModelProvider(this).get(CommonCategoryViewModel::class.java)
        ...
        adapter.setOnItemClickListener(this@TechnologyFragment)
        viewModel.fetchTopHeadlines(getString(R.string.ic_title_technology))
        viewModel.fetchTopHeadlines(getString(R.string.ic_title_technology))
